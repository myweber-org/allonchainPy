...
def clean_dataset(df, missing_strategy='mean', outlier_method='iqr', threshold=1.5):
    ...
    for col in numeric_cols:
        if outlier_method == 'iqr':
            ...
            cleaned_df.loc[z_scores > threshold, col] = mean_val
...
class DataCleaner:
    ...
    def get_summary(self):
        summary = {
            ...
            'clean_rows': self.df.shape[0],
            'original_columns': self.original_shape[1],
            'clean_columns': self.df.shape[1],
...
def validate_data(data, column, min_value=None, max_value=None, allowed_values=None):
    """
...
if __name__ == "__main__":
    ...
    sample_df.loc[95:99, 'value'] = [500, -200, 300, 450, 600]
