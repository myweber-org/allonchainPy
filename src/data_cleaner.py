...
def clean_dataframe(df, drop_duplicates=True, fill_na_method=None):
    """
    ...
    elif fill_na_method in ['ffill', 'bfill']:
...
if __name__ == "__main__":
    ...
    # Clean the data
    cleaned = clean_dataframe(df, fill_na_method='mean')
    print("\nCleaned DataFrame:")
    print(cleaned)
    print("\nShape:", cleaned.shape)
