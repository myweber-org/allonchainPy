...
def clean_dataset(df, drop_duplicates=True, fill_missing='mean'):
    ...
    Args:
        ...
        fill_missing: Strategy to handle missing values ('mean', 'median', 'mode', or 'drop')
...
def main():
    ...
    print(f"After cleaning 'value' column: {cleaned_df.shape}")
    
    # Clean all numeric columns
    fully_cleaned_df = clean_numeric_data(df)
    print(f"After cleaning all numeric columns: {fully_cleaned_df.shape}")
