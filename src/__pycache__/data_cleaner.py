...
if __name__ == "__main__":
    ...
    cleaned_df = clean_dataset('sample_dataset.csv', ['feature_a', 'feature_b'])
...
def get_cleaning_report(original_df, cleaned_df):
    ...
    report = {
        ...
        'removed_percentage': round((len(original_df) - len(cleaned_df)) / len(original_df) * 100, 2)
    }
...
if __name__ == "__main__":
    sample_data = {
        ...
        'pressure': [1013, 1014, 1015, 1016, 1017, 2000, 1019, 1020, 1021, 500]
    }
