...
if __name__ == "__main__":
    ...
    print("\nCleaned DataFrame (outliers in column 'A' removed):")
    print(cleaned_df)
...
if __name__ == "__main__":
    cleaned_data = example_usage()def remove_duplicates_preserve_order(input_list):
    seen = set()
    result = []
...
def process_example():
    """Example demonstrating the data cleaning functionality."""
    # Create sample data with duplicates and missing values
    data = {
        'id': [1, 2, 3, 1, 2, 6],
        'value': [10.5, 20.3, np.nan, 10.5, 20.3, 40.0],
    ...
    is_valid, message = validate_dataset(cleaned, required_columns=['id', 'value'], min_rows=1)
    print(f"\nValidation: {message}")
...
if __name__ == "__main__":
    ...
    try:
        validate_data(cleaned_df, numeric_cols)
