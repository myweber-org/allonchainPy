...
def clean_dataset(data, outlier_method='iqr', normalize_method='minmax', 
    ...
    return cleaned_data.reset_index(drop=True)import numpy as np
import pandas as pd
...
def clean_dataset(df, numeric_columns, method='iqr', normalize=True, standardize=False):
    cleaned_df = df.copy()
...
if __name__ == "__main__":
    ...
    validation_result, message = validate_data(cleaned, required_columns=['A', 'B', 'C'])
