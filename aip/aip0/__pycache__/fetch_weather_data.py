...
class WeatherFetcher:
    ...
    def _parse_weather_data(self, data):
        weather_info = {
            ...
            'sunrise': datetime.fromtimestamp(data.get('sys', {}).get('sunrise')).strftime('%H:%M:%S') if data.get('sys', {}).get('sunrise') else 'N/A',
            'sunset': datetime.fromtimestamp(data.get('sys', {}).get('sunset')).strftime('%H:%M:%S') if data.get('sys', {}).get('sunset') else 'N/A',
...
def main():
    ...
    for city in cities:
        ...
        if weather_data:
            ...
            print(f"Weather data saved to {city.lower().replace(' ', '_')}_weather.json")
        else:
