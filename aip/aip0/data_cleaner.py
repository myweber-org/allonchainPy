...
def clean_numeric_data(df, columns=None):
    ...
    If no columns specified, applies to all numeric columns.
...
def example_usage():
    ...
    sample_data[0, 0] = 10  # Add an obvious outlier
...
if __name__ == "__main__":
    sample_data = {
        ...
        'pressure': [1013, 1014, 1015, 1016, 1017, 1018, 1019, 1020, 2000, 900]
    }
