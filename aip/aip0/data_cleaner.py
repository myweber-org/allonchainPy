...
def validate_data(data, column):
    """Validate data by checking for NaN values and infinite values."""
    if data[column].isnull().any():
        print(f"Warning: Column '{column}' contains NaN values")
    
    if np.isinf(data[column]).any():
        print(f"Warning: Column '{column}' contains infinite values")
    
    return data[column].isnull().sum(), np.isinf(data[column]).sum()
...
if __name__ == "__main__":
    ...
    print("\nOriginal summary:")
    print(generate_summary(sample_data, ['feature1', 'feature2', 'feature3']))
    ...
    print("\nCleaned summary:")
    print(generate_summary(cleaned_data, ['feature1', 'feature2', 'feature3']))