...
if __name__ == "__main__":
    ...
    stats_col1 = calculate_basic_stats(cleaned, 1)
    print("Statistics for column 1:", stats_col1)
    
    stats_col2 = calculate_basic_stats(cleaned, 2)
    print("Statistics for column 2:", stats_col2)
import pandas as pd
