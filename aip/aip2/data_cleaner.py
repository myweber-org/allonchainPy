...
def remove_duplicates(df, subset=None, keep='first'):
    ...
    """
    return df.drop_duplicates(subset=subset, keep=keep)import numpy as np
import pandas as pd
...
def validate_data(df, required_columns):
    ...
    numeric_check = df[required_columns].apply(pd.to_numeric, errors='coerce')
    if numeric_check.isnull().any().any():
        raise ValueError("Non-numeric values found in required columns")
