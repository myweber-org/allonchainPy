...
def clean_dataset(input_file, output_file, method='iqr', normalize='minmax'):
    """Main function to clean dataset and save processed version."""
...
if __name__ == "__main__":
    ...
    cleaned_df = clean_dataset(input_csv, output_csv, method='iqr', normalize='minmax')
import numpy as np
import pandas as pd
...
def clean_dataset(data, numeric_columns=None, outlier_factor=1.5, normalization_method='minmax'):
    """
    Comprehensive data cleaning pipeline.
...
if __name__ == "__main__":
    ...
    print("\nCleaned data shape:", cleaned.shape)
    print("\nCleaned statistics for feature1_standardized:")
    print(calculate_statistics(cleaned, 'feature1_standardized'))import numpy as np
import pandas as pd
