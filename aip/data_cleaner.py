...
class DataCleaner:
    ...
    def summary(self):
        ...
        numeric_stats = self.df[self.numeric_columns].describe() if len(self.numeric_columns) > 0 else pd.DataFrame()
...
def create_sample_data():
    ...
    data['salary'][np.random.choice(100, 10)] = np.nan
