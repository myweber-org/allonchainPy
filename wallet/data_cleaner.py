...
if __name__ == "__main__":
    ...
    sample_df.loc[1000] = [100, 200, 2000]  # Extreme outlier
    sample_df.loc[1001] = [-50, -30, 800]   # Extreme outlier
    
    print("Original dataset shape:", sample_df.shape)
    
    columns_to_process = ['temperature', 'humidity', 'pressure']
    cleaned_data, statistics = clean_dataset(sample_df, columns_to_process)
