...
def process_dataset(file_path, column_name):
    ...
    try:
        ...
        stats = calculate_statistics(cleaned_data, column_name)
...
if __name__ == "__main__":
    ...
    print("Cleaned statistics:", calculate_statistics(cleaned, 'values'))import pandas as pd
...
if __name__ == "__main__":
    ...
    processed_data = clean_dataframe(raw_data, numeric_cols)
    save_cleaned_data(processed_data, output_file)import pandas as pd
