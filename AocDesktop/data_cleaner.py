...
if __name__ == "__main__":
    ...
    print("\n" + "="*50 + "\n")
    validation_passed = validate_dataframe(cleaned, required_columns=['id', 'name', 'age', 'score'], min_rows=3)
    
    if validation_passed:
        print("\nData cleaning completed successfully")
    else:
        print("\nData cleaning completed with validation issues")
...
def validate_data(data, check_missing=True, check_infinite=True):
    ...
    if check_missing:
        ...
        results['total_missing'] = missing_counts.sum()
