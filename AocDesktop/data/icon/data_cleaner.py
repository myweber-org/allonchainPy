...
if __name__ == "__main__":
    ...
    print(f"Original shape: {summary['original_rows']}x{summary['original_columns']}")
    print(f"Cleaned shape: {summary['cleaned_rows']}x{summary['cleaned_columns']}")
    print(f"Rows removed: {summary['rows_removed']}")
    print(f"Remaining missing values: {summary['missing_values']}")
import pandas as pd
...
if __name__ == "__main__":
    ...
    cleaned_data = clean_dataset(sample_data, numeric_cols, outlier_method='iqr', normalize_method='minmax')
