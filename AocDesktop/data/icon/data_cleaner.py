...
def validate_data(data, required_columns=None, allow_nan_ratio=0.1):
    ...
    for column in data.columns:
        ...
        if nan_ratio > allow_nan_ratio:
            validation_report.append(f"Column '{column}' has {nan_ratio:.1%} NaN values (threshold: {allow_nan_ratio:.1%})")
...
def clean_dataframe(df, drop_duplicates=True, fill_missing='mean'):
    ...
    print(f"Filled missing values in non-numeric columns with 'Unknown'.")
