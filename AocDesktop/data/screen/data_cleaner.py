...
def create_sample_data():
    ...
    outliers = np.random.choice([True, False], 100, p=[0.1, 0.9])
    df.loc[outliers, 'feature_a'] = df.loc[outliers, 'feature_a'] * 5
    
    missing = np.random.choice([True, False], 100, p=[0.05, 0.95])
...
def calculate_cleaning_stats(original_df, cleaned_df):
    """
    Calculate statistics about the data cleaning process.
...
if __name__ == "__main__":
    ...
    stats = calculate_cleaning_stats(df, cleaned_df)
    print("\nCleaning Statistics:")
