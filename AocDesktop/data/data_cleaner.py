...
if __name__ == "__main__":
    ...
    print(f"Data cleaning complete. Cleaned data saved to {output_file}")import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    sample_data = {
        'id': [1, 2, 3, 4, 5, 5, 6],
        'value': [10.5, 20.3, None, 15.7, 12.1, 12.1, None],
        'category': ['A', 'B', 'A', None, 'C', 'C', 'B'],
        'score': [85, 92, 78, None, 88, 88, 95]
    }
    ...
    is_valid = validate_dataset(cleaned, required_columns=['id', 'value', 'category'])
